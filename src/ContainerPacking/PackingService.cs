using OpenCodeDev.NetCMS.Tools.ContainerPacking.Algorithms;
...
namespace OpenCodeDev.NetCMS.Tools.ContainerPacking
{
    /// <summary>
    ...
    public static class PackingService
	{
		...
		public static List<ContainerPackingResult> Pack(List<Container> containers, List<Item> itemsToPack) => Pack(containers, itemsToPack, [(int)AlgorithmType.EB_AFIT]);
